...
**What I have learned:**
- How to analyse audio files with FFT
- How to create custom GUIs with Custom TKinter
- How to implement audio playback with corresponding controls

**Future Improvements:**
- Learn to switch between bars and smoothed lines
- Learn to export visualised audios as video files
